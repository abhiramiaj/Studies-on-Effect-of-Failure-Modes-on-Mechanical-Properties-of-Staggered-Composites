function t = swshear1(x,n,Ep,Em,num,b,Lb,h,s5,rho)
%swshear1 defined as a stand-alone function of s5
%bottom value is taken as default function output
Lp=rho*b*2;
%%% L is the length of stairwise RVE model
L=Lp+(2*Lb);
La1=(L./n)-(2*Lb);
%La1=(Lp/n)-(2*Lb); %changed for trial 2020aug12 See fig in zhang 2010 for explanation
