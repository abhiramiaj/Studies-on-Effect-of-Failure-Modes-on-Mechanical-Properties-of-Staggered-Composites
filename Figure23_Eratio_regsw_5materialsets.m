...
SMP1(i)=(Eregkim(Ep1,Em1,num1,b,Lb(i),h(i),rr(i)))./EregkimBzer(Ep1,Em1,num1,b,Lb(i),h(i),rr(i));
...
Lb(i)=hnol*rr(i)*b/(1+hnol);
h(i)=(2*b*rr(i)*2*b./(vf*(0.5*2*b*rr(i) + Lb(i)))) - (2*b);
SMP1(i)=(Eswkim(n,Ep1,Em1,num1,b,Lb(i),h(i),rr(i)))./EswkimBzer(n,Ep1,Em1,num1,b,Lb(i),h(i),rr(i));
