function s1 = regstressBzer(x,Ep,Em,num,b,Lb,h,s5,rho)
% if the load transfer through the soft tip region(vif) is additionally ignored by setting parameter B to zero
n=2;
Lp=rho*b*2;
% x=0:0.1:La 
